...
// contact-hero-bg.jpg     → hero background (autumn leaves/branches)
// contact-table.jpg       → dining table with glasses & lemons
// contact-building.jpg    → restaurant building with glass walls
...
function FullscreenMenu({ onClose }) {
  ...
  const navItems = [
    ...
    { name: 'CONTACT', path: '/contact', active: true,  sub: [] },
  ];
  ...
  return (
    <div className="bg-white" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
      ...
      <section className="bg-white py-24">
        <div className="max-w-5xl mx-auto px-20">
          <div className="grid grid-cols-2 gap-16 items-center">
            ...
            {/* LEFT — dining table image + bird SVG decoration */}
            <div className="relative">
              {/* 🖼️ contact-table.jpg */}
              <div className="overflow-hidden" style={{ width: '320px', height: '280px' }}>
                <img
                  src="/images/contact-table.jpg"
                  alt="Restaurant Table"
                  className="w-full h-full object-cover"
                />
              </div>

              {/* Bird / floral SVG decoration — top right of image */}
              <div className="absolute" style={{ top: '-30px', right: '-20px', width: '160px', opacity: 0.7 }}>
                <svg viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                  {/* bird body */}
                  <path d="M90 60 C80 50, 60 45, 50 55 C40 65, 45 80, 60 85 C75 90, 95 80, 100 70 C105 60, 100 50, 90 60Z"
                    stroke="#3a4a1a" strokeWidth="1.2" fill="none"/>
                  {/* wing */}
                  <path d="M70 65 C60 55, 40 50, 35 60 C30 70, 45 78, 60 75"
                    stroke="#3a4a1a" strokeWidth="1.2" fill="none"/>
                  {/* tail */}
                  <path d="M100 70 C115 65, 130 55, 135 60 C125 70, 115 75, 100 72"
                    stroke="#3a4a1a" strokeWidth="1.2" fill="none"/>
                  {/* beak */}
                  ...
                  {/* branch */}
                  <path d="M40 110 C60 100, 80 95, 100 90 C120 85, 140 90, 155 100"
                    stroke="#3a4a1a" strokeWidth="1.2" fill="none"/>
                  {/* leaves */}
                  <path d="M70 97 C65 88, 72 82, 78 88 C80 92, 74 98, 70 97Z"
                    stroke="#3a4a1a" strokeWidth="1" fill="none"/>
                  <path d="M100 90 C95 80, 103 74, 108 81 C110 85, 104 91, 100 90Z"
                    stroke="#3a4a1a" strokeWidth="1" fill="none"/>
                  <path d="M130 92 C126 82, 134 77, 138 84 C140 88, 134 93, 130 92Z"
                    stroke="#3a4a1a" strokeWidth="1" fill="none"/>
                  {/* star/sparkle */}
                  <path d="M148 55 L150 50 L152 55 L157 57 L152 59 L150 64 L148 59 L143 57 Z"
                    stroke="#3a4a1a" strokeWidth="0.8" fill="none"/>
                </svg>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-base leading-relaxed"
                style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '18px' }}>
                email{' '}
                <a href="mailto:info@foodzero.com" className="text-[#b5b820] hover:underline">
                  info@foodzero.com
                </a>
              </p>
              <p className="text-gray-600 text-base leading-relaxed"
                style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '18px' }}>
                or telephone on{' '}
                <a href="tel:+86852346000" className="text-[#b5b820] hover:underline">
                  +86 852 346 000
                </a>
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-20">
          <div className="grid grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <button
                className="border border-gray-800 text-gray-800 px-8 py-3 text-sm tracking-wider hover:bg-gray-800 hover:text-white transition-all"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              >
                View in maps
              </button>
      ...
      <section className="bg-[#f0efe8] py-24 relative overflow-hidden">
        ...
        {/* Leaf decoration behind title */}
        <div className="absolute left-16 top-10 opacity-20 pointer-events-none" style={{ width: '120px' }}>
          <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M60 10 C40 10, 15 30, 12 60 C9 90, 25 118, 55 128 C58 129, 60 130, 60 130 C60 130, 62 129, 65 128 C95 118, 111 90, 108 60 C105 30, 80 10, 60 10Z"
              stroke="#3a4a1a" strokeWidth="1.5" fill="none"/>
            <path d="M60 10 L60 130" stroke="#3a4a1a" strokeWidth="1" fill="none"/>
            <path d="M60 35 C48 38, 28 44, 15 58" stroke="#3a4a1a" strokeWidth="0.8" fill="none"/>
            <path d="M60 58 C45 60, 22 68, 14 82" stroke="#3a4a1a" strokeWidth="0.8" fill="none"/>
            <path d="M60 80 C48 83, 30 90, 24 105" stroke="#3a4a1a" strokeWidth="0.8" fill="none"/>
            <path d="M60 35 C72 38, 92 44, 105 58" stroke="#3a4a1a" strokeWidth="0.8" fill="none"/>
            <path d="M60 58 C75 60, 98 68, 106 82" stroke="#3a4a1a" strokeWidth="0.8" fill="none"/>
            <path d="M60 80 C72 83, 90 90, 96 105" stroke="#3a4a1a" strokeWidth="0.8" fill="none"/>
          </svg>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="border border-gray-300 bg-white px-5 py-3 text-sm text-gray-600 placeholder-gray-400 outline-none focus:border-[#5a6e2a]"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              />
              <input
                type="text"
            ...
            <input
              ...
              className="w-full border border-gray-300 bg-white px-5 py-3 text-sm text-gray-600 placeholder-gray-400 outline-none focus:border-[#5a6e2a]"
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
            />
            ...
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="border border-gray-300 bg-white px-5 py-3 text-sm text-gray-600 outline-none focus:border-[#5a6e2a]"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              />
              <div className="relative">
                <select
            ...
            <div className="flex justify-center mt-4">
              <button
                className="bg-[#3a4a1a] text-white px-20 py-4 text-sm tracking-widest uppercase hover:bg-[#4a5e22] transition-colors"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              >
                Book Now
              </button>
