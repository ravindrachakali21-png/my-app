    ...
    <footer className="bg-[#2d3a10] text-white pt-16 pb-8">
      <div className="max-w-5xl mx-auto px-16">
        <div className="grid grid-cols-3 gap-12 mb-12">
          <div>
            <span className="text-white font-serif font-light" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '40px', lineHeight: '1.1' }}>
              Food<br />Zero.
            </span>
          </div>
          <div>
  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-30 flex items-center justify-between px-10 py-5">
      <div className="flex items-center gap-4">
        ...
        <button onClick={onMenuClick} className="flex flex-col gap-1.5 ml-2 cursor-pointer">
...
// ── Re-export FullscreenMenu so blog pages can import from here ──
